    ...
    return (
      <div className ="resume">
        <div className="download-section" >
          <a id="download" href={ResumeDoc}>Download </a>
        </div>
        <div className="Resume-text">
        <div className="resume-header">
          <h1> Bailey Bryant </h1>
          <h2> Front End Web Developer</h2>
          <p>ATX | 512.507.4810 | bailey.bryant10[@]gmail.com | <a href="https://www.linkedin.com/in/bailey-bryant/" >LinkedIn</a> | <a href="https://github.com/bbryant7">GitHub </a></p>
          </div>
          <h3> SKILLS </h3>
